...
# Description: This file contains the code for the baseline experiments with error bars
...
for i in range(args.repeat):
    ...
    sev_arr,positive_count = SEVPlot(model,encoder, X_test, args.SEV_mode, max_depth=args.max_depth, max_time=args.max_time)
    ...
    temp_result.to_csv("../Results/Exp0/data/%s_%s_%s_%d.csv"%(args.dataset,args.model,args.SEV_mode,i),index=False)
...
# save the results
result_file = open('../Results/Exp0/result.csv','a')
# write the results
